    ...
    <nav className="w-full fixed top-0 left-0 z-50 backdrop-blur-lg bg-white/10 border-b border-white/20">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <ul className="hidden md:flex gap-12 text-gray-700 font-medium">
          ...
          <li className="hover:text-blue-600 transition">Cards</li>
        ...
        <button className="hidden md:block px-5 py-2 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all">
          Login
        </button>
      ...
      {open && (
        <div className="md:hidden bg-white/80 backdrop-blur-lg px-6 py-4 flex flex-col gap-4 text-gray-800 font-medium border-b border-gray-200">
          ...
          <a className="py-2 hover:text-blue-600 transition">Cards</a>
          ...
          <button className="mt-2 w-full px-5 py-2 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all">
            Login
          </button>
        </div>
      )}
